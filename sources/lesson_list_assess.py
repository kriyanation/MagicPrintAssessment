...
class MagicLessonList(Toplevel):
    def __init__(self, bg,fg,buttonbg,buttonfg,selectmode,parent,*args, **kwargs):
        ...
        self.choice_label = ttk.Label(self, text="Select Lessons to Print Assessments ",
    ...
    def select_lesson(self):
       print(self.choice_list.get(self.choice_list.curselection()))
       self.parent.selected_lessons = self.choice_list.get(self.choice_list.curselection())
       self.destroy()
